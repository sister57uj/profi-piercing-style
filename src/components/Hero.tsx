      ...
      <div className="container mx-auto px-3 sm:px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8 md:space-y-12 animate-fade-in py-12 sm:py-16 md:py-20">
          <div className="space-y-4 sm:space-y-5 md:space-y-6">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-display font-bold text-foreground leading-[1.1] break-words px-4">
              <EditableText
                initialValue={title}
                onSave={setTitle}
                page="home"
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 pt-6 sm:pt-7 md:pt-8 max-w-3xl mx-auto px-4 sm:px-6">
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-2 sm:p-4 md:p-6 hover:border-primary/50 transition-all hover-lift">
              <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-2 sm:mb-3 md:mb-4">
                <svg className="w-4 h-4 sm:w-6 sm:h-6 md:w-7 md:h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <p className="text-foreground font-semibold text-xs sm:text-base md:text-lg mb-1">Стерильность</p>
              <p className="text-muted-foreground text-[10px] sm:text-xs md:text-sm">Медицинские стандарты</p>
            </div>
            ...
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-2 sm:p-4 md:p-6 hover:border-primary/50 transition-all hover-lift">
              ...
              <p className="text-foreground font-semibold text-xs sm:text-base md:text-lg mb-1">Безопасность</p>
              <p className="text-muted-foreground text-[10px] sm:text-xs md:text-sm">Сертифицированные мастера</p>
            </div>
            ...
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-2 sm:p-4 md:p-6 hover:border-primary/50 transition-all hover-lift">
              ...
              <p className="text-foreground font-semibold text-xs sm:text-base md:text-lg mb-1">Красота</p>
              <p className="text-muted-foreground text-[10px] sm:text-xs md:text-sm">Индивидуальный подход</p>
            </div>
          </div>
